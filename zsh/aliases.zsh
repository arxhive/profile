...
alias tfp-alpha="tfwu && tfp -var-file='env/alpha.tfvars'"
alias tfp-qa="tfwu && tfp -var-file='env/qa.tfvars'"
alias tfp-test="tfwu && tfp -var-file='env/test.tfvars'"
alias tfp-staging="tfwu && tfp -var-file='env/staging.tfvars'"
alias tfp-preprod="tfwu && tfp -var-file='env/preprod.tfvars'"
alias tfp-prod="tfwu && tfp -var-file='env/prod.tfvars'"
...
alias tfa-alpha="tfwu && terraform apply -auto-approve -var-file='env/alpha.tfvars'"
alias tfa-qa="tfwu && terraform apply -auto-approve -var-file='env/qa.tfvars'"
alias tfa-test="tfwu && terraform apply -auto-approve -var-file='env/test.tfvars'"
alias tfa-staging="tfwu && terraform apply -auto-approve -var-file='env/staging.tfvars'"
alias tfa-preprod="tfwu && terraform apply -auto-approve -var-file='env/preprod.tfvars'"
alias tfa-prod="tfwu && terraform apply -auto-approve -var-file='env/prod.tfvars'"
